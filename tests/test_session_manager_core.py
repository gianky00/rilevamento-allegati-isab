...
class TestSessionManager(unittest.TestCase):
    ...
    def test_load_session_missing(self):
        ...
        tasks, _odc = SessionManager.load_session()
        self.assertEqual(tasks, [])
        self.assertEqual(_odc, "Unknown")
    ...
    def test_load_session_corrupted(self, mock_log):
        ...
        # Avoid generic Exception for B017 if possible, or use a specific one
